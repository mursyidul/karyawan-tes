...
class Login extends CI_Controller {
	...
	public function proses(){
		...
		if($cek_user == FALSE){
			...
			$this->session->set_userdata('aktif',$cek_user->aktif);
	...
	public function daftar_proses(){
		if($this->input->post('simpan')){
			...
			$this->session->set_flashdata('pesan', "<div class='alert alert-dismissible alert-success'><button type='button' class='close' id='hide' data-dismiss='alert'>&times;</button>Menungguh konfirmasi dari admin !!!</div>");
			redirect(base_url());
