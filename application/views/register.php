...
<head>
    <meta charset="UTF-8">
    <title>SISTEM KARYAWAN EMCORP STUDIO</title>
    ...
    <section class="content">
        <div class="row" style="margin-top:1%;">
            ...
            <div class="col-md-6">
                ...
                <center><h3>SISTEM KARYAWAN EMCORP STUDIO</h3><hr/>
                ...
                <p>&nbsp;</p>
                <center><sub>Copyright &copy; SISTEM KARYAWAN EMCORP STUDIO, <?php echo date('Y'); ?></sub></center>
            </div>
            <div class="col-md-3"></div>
        </div></div>
    </section>
